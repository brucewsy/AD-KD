...
def parse_args():
    ...
    parser.add_argument("--distill_loss",type=str, default="kd",
                        help="Distillation Loss type. [kd |saliency | integrated_saliency |mgskd]    \
                        Separate the distillation loss to be used with +. For example, kd+saliency")
    ...
    parser.add_argument("--saliency_w", default=1.0, type=float,
